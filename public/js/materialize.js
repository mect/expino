      ...
      */
      function placeDropdown(eventType) {
        ...
        if (currAlignment === "left") {
          ...
          var offsetRight =
            origin.position().left + originWidth - activates.width();
          gutterSpacing = -curr_options.gutter;
            ...
            var enterVelocityOptions = {
              ...
              complete: function () {
                if (typeof _this.options.ready === "function") {
                  _this.options.ready.call(
                    _this,
                    _this.$el,
                    _this.openingTrigger
                  );
                }
              },
            };
    ...
    init: function (options) {
      ...
      $(this).each(function () {
        ...
        if (options.draggable) {
          ...
          $dragTarget = $('<div class="drag-target"></div>').attr(
            "data-sidenav",
            menuId
          );
...
(function ($) {
  ...
  $.scrollSpy = function (selector, options) {
    ...
    selector.on("scrollSpy:enter", function () {
      ...
      if (visible[0]) {
        $(options.getActiveElement(visible[0].attr("id"))).removeClass(
          options.activeClass
        );
      ...
      $(options.getActiveElement(visible[0].attr("id"))).addClass(
        options.activeClass
      );
    });
  ...
  $.winSizeSpy = function (options) {
    ...
    return jWindow.on(
      "resize",
      Materialize.throttle(onWinSize, options.throttle || 100)
    );
  };
    ...
    $(this).each(function () {
      ...
      var appendOptionWithIcon = function (select, option, type) {
        ...
        var multipleCheckbox = multiple
          ? '<input type="checkbox"' + disabledClass + "/><label></label>"
          : "";
  ...
  var methods = {
    init: function (options) {
      ...
      return this.each(function (i) {
        ...
        var showIndicators =
          (view.attr("data-indicators") || options.indicators) &&
          hasMultipleSlides;
        var noWrap =
          view.attr("data-no-wrap") || options.noWrap || !hasMultipleSlides;
          ...
          if (firstImage.length) {
            if (firstImage[0].complete) {
              ...
              if (imageHeight > 0) {
                ...
                var adjustedHeight =
                  (view.width() / naturalWidth) * naturalHeight;
...
(function ($) {
    ...
    init: function (options) {
      return this.each(function () {
        ...
        if (!tapTargetWrapper.length) {
          tapTargetWrapper = tapTargetEl
            .wrap($('<div class="tap-target-wrapper"></div>'))
            .parent();
        }
        ...
        var openTapTarget = function () {
          ...
          setTimeout(function () {
            ...
            $(window)
              ...
              .on("resize.tapTarget", throttledCalc);
          }, 0);
        };
        ...
        var calculateTapTarget = function () {
          ...
          var originTop = isFixed
            ? origin.offset().top - $(document).scrollTop()
            : origin.offset().top;
          var originLeft = isFixed
            ? origin.offset().left - $(document).scrollLeft()
            : origin.offset().left;
          ...
          var isCenterY =
            originTop >= windowHeight * 0.25 &&
            originTop <= windowHeight * 0.75;
          ...
          tapTargetWrapperCssObj.right = isRight
            ? windowWidth - tapTargetLeft - tapTargetWidth
            : "";
          tapTargetWrapperCssObj.bottom = isBottom
            ? windowHeight - tapTargetTop - tapTargetHeight
            : "";
  ...
  $.fn.tapTarget = function (methodOrOptions) {
    ...
    $.error(
      "Method " + methodOrOptions + " does not exist on jQuery.tap-target"
    );
  };
})(jQuery);
